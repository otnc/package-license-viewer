...
} = require("../out/providers/moonbit/dsl");
const { parseManifest, manifestFormat } = require("../out/providers/moonbit/parse");
const { parseIndex } = require("../out/providers/moonbit/registryIndex");
const {
  isModuleName,
  isModuleVersion,
  isRegistryModuleName,
} = require("../out/providers/moonbit/spec");
const { MoonbitLicenseProvider } = require("../out/providers/moonbit");
